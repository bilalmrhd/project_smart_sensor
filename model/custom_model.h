...
#define MODEL_SCALE_INPUT 0.019583612f   // Input scaling factor (converts input values to model-specific scale)
#define MODEL_SCALE_OUTPUT 0.20851851f   // Output scaling factor (converts output values from model-specific scale)
#define MODEL_INPUT_ZERO_POINT -19       // Zero-point for input data (used in quantized models)
#define MODEL_OUTPUT_ZERO_POINT 59       // Zero-point for output data (used in quantized models)
